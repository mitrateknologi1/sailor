            ...
            <div class="col">
                <div class="card ">
                    ...
                    <div class="card-body pt-2">
                        <div class="row mb-0">
                            @component('dashboard.components.info.masterData.bidan')
                            @endcomponent
                            <div class="col">
                ...
                success: function(data) {
                    ...
                    if (data.foto_profil != null) {
                        $('#modal-foto-profil').html(
                            '<div class="image-input avatar xxl rounded-4" style="background-image: url({{ Storage::url('upload/foto_profil/bidan/') }}' +
                            data.foto_profil + ')">')
                    } else {
                        $('#modal-foto-profil').html(
                    ...
                    if ('{{ Auth::user()->role }}' == 'admin') {
                        ...
                        $('#modal-btn-ubah').attr('href', '{{ url('bidan') }}' + '/' + id +
                            '/edit');
