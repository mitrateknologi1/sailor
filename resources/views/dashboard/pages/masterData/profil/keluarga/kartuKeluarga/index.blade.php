                            ...
                            <div class="card-body p-0 py-1 px-1">
                                <ul class="list-unstyled mb-0">
                                    <li class="justify-content-between mb-2">
                                        ...
                                        <span class="badge bg-info float-end text-uppercase" id="modal-nomor-kartu-keluarga"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-person fa-lg"></i> Nama Kepala Keluarga</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-nama-kepala-keluarga"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                    ...
                                    <li class="justify-content-between mb-2">
                                        ...
                                        <span class="badge bg-info float-end text-uppercase" id="modal-kode-pos"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                    ...
                                    <li class="justify-content-between">
                                        ...
                                        <a href="#" id="file-kartu-keluarga" target="_blank"><span class="badge bg-success shadow float-end text-uppercase" id="modal-provinsi">Lihat</span></a>
                                        <span class="badge bg-info shadow float-end text-uppercase" id="modal-kartu-keluarga">Tidak Ada</span>
                                    </li>
                        ...
                        <div class="card fieldset border border-dark">
                            ...
                            <div class="card-body p-0 py-1 px-1">
                                <ul class="list-unstyled mb-0">
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-id-card"></i> Nomor Kartu Keluarga</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-nomor-kartu-keluarga2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-person fa-lg"></i> Nama Kepala Keluarga</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-nama-kepala-keluarga2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-road"></i> Alamat</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-alamat2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-signs-post"></i> RT/RW</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-rt-rw2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-envelope"></i> Kode POS</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-kode-pos2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-location-dot"></i> Desa/Kelurahan</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-desa-kelurahan2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-location-dot"></i> Kecamatan</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-kecamatan2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-location-dot"></i> Kabupaten/Kota</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-kabupaten-kota2"> - </span>
                                    </li>
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-location-dot"></i> Provinsi</label>
                                        <span class="badge bg-info float-end text-uppercase" id="modal-provinsi2"> - </span>
                                    </li>                            
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-clipboard-question"></i> Status</label>
                                    ...
                                    <li class="justify-content-between mb-2">
                                        <label><i class="fa-solid fa-file"></i> Kartu Keluarga</label>
                                        <a href="#" id="file-kartu-keluarga2" target="_blank"><span class="badge bg-success shadow float-end text-uppercase" id="modal-provinsi">Lihat</span></a>
                                        <span class="badge bg-info shadow float-end text-uppercase" id="modal-kartu-keluarga2">Tidak Ada</span>
                                    </li>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.file_kk){
                        ...
                        $('#file-kartu-keluarga').attr('href', '{{ asset("upload/kartu_keluarga") }}/'+data.file_kk);
                        ...
                        $('#modal-btn-validasi').click(function(e){
                            ...
                            Swal.fire({
                                ...
                                if (result.value) {
                                    $.ajax({
                                        type: "PUT",
                                        url: "{{url('keluarga/validasi')}}" + '/' + data.id,
                                        data: {
                                            _token: "{{csrf_token()}}",
                                            id: data.id,
                                            bidan_id: bidan_id,
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.file_kk){
                        ...
                        $('#file-kartu-keluarga2').attr('href', '{{ asset("upload/kartu_keluarga") }}/'+data.file_kk);
                    ...
                    if(data.is_valid == 1){
                        ...
                        $('#modal-btn-ubah').attr('href', '{{url('keluarga')}}' + '/' + data.id + '/edit');
