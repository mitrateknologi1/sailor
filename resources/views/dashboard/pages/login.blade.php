                        ...
                        <div class="card shadow-sm w-100 p-4 p-md-5 px-md-3" style="max-width: 35rem;">
                            ...
                            <div class="card-header justify-content-center py-4">
                                <ul class="nav nav-tabs tab-page-toolbar rounded d-inline-flex" role="tablist">
                                    <li class="nav-item" id="keluarga"><a class="nav-link border-0 active" data-bs-toggle="tab" id="nav-link-keluarga" href="#nav-keluarga" role="tab"><i class="fa-solid fa-people-roof"></i> Keluarga</a></li>
                                    <li class="nav-item" id="bidan"><a class="nav-link border-0"  data-bs-toggle="tab" id="nav-link-bidan" href="#nav-bidan" role="tab"><i class="fa-solid fa-user-doctor"></i> Bidan</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-keluarga" role="tabpanel">
                                        <form class="row g-3 w-100 justify-content-center form-login" action="/cekLogin" method="POST">
                                            ...
                                            <input type="hidden" id="role" class="form-control form-control" name="role" value="keluarga">
                                            @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="password" id="kata_sandi" name="password" class="form-control form-control-lg" placeholder="***************">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 text-center mt-4">
                                                <span class="text-muted">Belum Punya Akun? <a href="{{ route('registrasi') }} ">Daftar disini</a></span>
                                            </div>
                                        </form>
                                    </div>
                ...
                if (response.res == 'ditolak'){
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "{{url('registrasi-ulang/')}}"+"/"+response.id;
