                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @if ($data['is_valid_mencegah_pernikahan_dini'] == 0 && Auth::user()->role != 'keluarga')
                                ...
                                <div class="row g-2 mt-2">
                                    ...
                                    @endif
                                    @if ((Auth::user()->profil->id == $randaKabilasa->bidan_id || Auth::user()->role == 'admin') && $data['is_valid_mencegah_pernikahan_dini'] == 1)
                                        <div class="col-sm-6 col-lg">
    ...
    <script>
        ...
        $(document).on('click', '#modal-btn-konfirmasi', function() {
            ...
            Swal.fire({
                ...
                text: "Konfirmasi data mencegah pernikahan dini ini?",
                icon: 'question',
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: "PUT",
                        url: "{{ url('mencegah-pernikahan-dini/validasi') }}" + '/' + id + '/' +
                            id,
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id,
