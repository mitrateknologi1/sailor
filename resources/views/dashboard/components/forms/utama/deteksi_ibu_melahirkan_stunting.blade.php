        ...
        <div class="col-sm-12 col-lg-12">
            ...
            @if ($daftarSoal)
                @foreach ($daftarSoal as $soal)
                    ...
                    @if (isset($method) && $method == 'PUT')
                        @php
                            $jawabanSoal = \App\Models\JawabanDeteksiIbuMelahirkanStunting::where('deteksi_ibu_melahirkan_stunting_id', $dataEdit->id)
            ...
            <div class="modal-content">
                <div class="modal-body custom_scroll p-lg-4 pb-3">
                    <div class="d-flex w-100 justify-content-between mb-1">
                        <div>
                            <h5>Hasil Deteksi Ibu Melahirkan Stunting</h5>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                if (data.kategori == 'Beresiko Melahirkan Stunting') {
