    ...
    <div class="col-lg-6 col-md-6">
        ...
        <div class="col-md-9 col-sm-8">
            <div class="image-input avatar xxl rounded-4"
                style="background-image: url({{ isset($anggotaKeluarga) && $anggotaKeluarga->foto_profil != null ? asset('storage/upload/foto_profil/keluarga/' . $anggotaKeluarga->foto_profil) : asset('assets/dashboard/images/avatar.png') }});">
