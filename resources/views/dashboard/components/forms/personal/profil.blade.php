    ...
    <div class=" col-md-6">
        ...
        <div class="col-md-9 col-sm-8">
            <div class="image-input avatar xxl rounded-4"
                style="background-image: url({{ isset($profil) && $profil->foto_profil != null ? asset('upload/foto_profil/' . $user->role . '/' . $profil->foto_profil) : asset('assets/dashboard/images/avatar.png') }});">
