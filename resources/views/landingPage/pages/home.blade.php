  ...
  <![endif]-->
   ...
   <div id="main-wrapper" class="main-wrapper">
            ...
            <div class="container">
               <div class="header-navbar">
                  <div class="header-logo">
                     <a href="index-1.html"><img class="light-version-logo" src="{{ asset('assets/logo') }}/logo1.png"
                           alt="logo" width="280em"></a>
                     <a href="index-1.html"><img class="dark-version-logo" src="{{ asset('assets/logo') }}/logo2.png"
                           alt="logo" width="280em"></a>
                     <a href="index-1.html"><img class="sticky-logo" src="{{ asset('assets/logo') }}/logo1.png"
                           alt="logo" width="280em"></a>
                  </div>
                  <div class="header-main-nav">
                     ...
                     <nav class="mainmenu-nav" id="mobilemenu-popup">
                        <div class="d-block d-lg-none">
                           <div class="mobile-nav-header">
                              <div class="mobile-nav-logo">
                                 <a href="index-1.html">
                                    <img class="light-mode" src="{{ asset('assets/logo') }}/logo1.png" alt="Site Logo">
                                    <img class="dark-mode" src="{{ asset('assets/logo') }}/logo2.png" alt="Site Logo">
                                 </a>
                              </div>
                        ...
                        <ul class="mainmenu">
                           {{-- if guest --}}
                           @if (Auth::guest())
                              <li><a href="{{ url('/login') }}"><i class="fa-solid fa-arrow-right-to-bracket"></i>
                                    LOGIN</a></li>
                           @else
                  ...
                  <div class="header-action">
                     <ul class="list-unstyled">
                        ...
                        <li class="my_switcher d-block d-lg-none">
                           <ul>
                              <li title="Light Mode">
                                 <a href="javascript:void(0)" class="setColor light active" data-theme="light">
                                    <i class="fal fa-lightbulb-on"></i>
                                 </a>
                              </li>
                              <li title="Dark Mode">
         ...
         <div class="container">
            ...
            <div class="banner-thumbnail">
               <div class="large-thumb" data-sal="slide-left" data-sal-duration="800" data-sal-delay="400">
                  <img class="paralax-image" src="{{ asset('assets/landingPage') }}/preview/peta.png" alt="Shape"
            ...
            <div class="row justify-content-center">
               ...
               <div class="col-lg-3 col-6 " data-sal="slide-up" data-sal-duration="800" data-sal-delay="400">
                  <div class="counterup-progress">
                     ...
                     <div class="count-number h2">
                        <span class="number count odometer odometer-auto-theme" data-count="{{ $deteksiDiniCount }}">
                        </span>
                     </div>
                     <span class="text-muted mb-1">Moms Care</span>
               ...
               <div class="col-lg-3 col-6 " data-sal="slide-up" data-sal-duration="800" data-sal-delay="400">
                  <div class="counterup-progress">
                     ...
                     <div class="count-number h2">
                        <span class="number count odometer odometer-auto-theme" data-count="{{ $ancCount }}">
                        </span>
                     </div>
                     <span class="text-muted mb-1">Moms Care</span>
      ...
      <footer class="footer-area">
         ...
         <div class="container">
            <div class="footer-bottom text-center" data-sal="slide-up" data-sal-duration="500" data-sal-delay="100">
               <div class="row">
                  <div class="col">
