...
namespace App\Http\Controllers\api\const;
...
class ApiDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return response([
            compact([$stuntingAnak, $ibuMelahirkanStunting, $perkiraanMelahirkan, $deteksiDini, $anc, $pertumbuhanAnak, $perkembanganAnak, $randaKabilasa, $anggotaKeluarga, $keluarga]),
        ], 200);
    }
