...
class ApiIbuMelahirkanStuntingController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (in_array(Auth::user()->role, ['bidan', 'penyuluh'])) {
            ...
            $data = DeteksiIbuMelahirkanStunting::with('anggotaKeluarga.kartuKeluarga', 'anggotaKeluarga.wilayahDomisili.provinsi', 'anggotaKeluarga.wilayahDomisili.kabupatenKota', 'anggotaKeluarga.wilayahDomisili.kecamatan', 'anggotaKeluarga.wilayahDomisili.desaKelurahan', 'bidan')->orderBy('created_at', 'DESC')
            ...
            $deteksiIbuMelahirkanStunting = DeteksiIbuMelahirkanStunting::with('anggotaKeluarga.kartuKeluarga', 'anggotaKeluarga.wilayahDomisili.provinsi', 'anggotaKeluarga.wilayahDomisili.kabupatenKota', 'anggotaKeluarga.wilayahDomisili.kecamatan', 'anggotaKeluarga.wilayahDomisili.desaKelurahan', 'bidan')->whereHas('anggotaKeluarga', function ($query) use ($kartuKeluarga) {
                $query->where('kartu_keluarga_id', $kartuKeluarga);
            })->latest()->get();
            return $deteksiIbuMelahirkanStunting;
        }
    }
